...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4 md:px-8">
      <h1 className="text-3xl md:text-4xl font-bold text-blue-700 mb-8 md:mb-10 text-center pt-16 md:pt-20">Contact Us</h1>

      <div className="w-full max-w-6xl mx-auto flex flex-col items-center gap-8 md:gap-10">
        {/* Contact Form */}
        <form
          onSubmit={handleSubmit}
          className="w-full max-w-2xl bg-white p-6 md:p-8 shadow-md rounded-lg"
        >
          ...
          <div className="mb-4 md:mb-6">
            ...
            <textarea
              ...
              required
              rows="6"
              className="w-full px-4 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-black resize-vertical"
        ...
        {/* Google Map */}
        <div className="w-full max-w-4xl h-[300px] md:h-[400px] rounded-lg overflow-hidden shadow-md">
          <iframe
            title="Google Map"
